...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-red-950 to-green-950 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-white/10 hover:bg-red-600 rounded-lg transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#shop" className="text-gray-300 hover:text-red-400 transition-colors">Shop</a></li>
              <li><a href="#collection" className="text-gray-300 hover:text-red-400 transition-colors">Collections</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-red-400 transition-colors">Track Order</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-400 transition-colors">Shipping Info</a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-400 transition-colors">Returns</a></li>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 Morocco Store. All rights reserved.
            </p>
